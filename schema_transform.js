...
function raiosFunc (schemaObjOrBoolean, pathToSchemaFromParent, parentSchemaObjectIfAny, pathFromSchemaToParent) {
    ...
    if ((pathToSchemaFromParent[0] === "properties") && ((pathToSchemaFromParent[1] === "arch") || (pathToSchemaFromParent[1] === "architecture"))) {
        console.log("Found a arch, I think....", pathToSchemaFromParent);
        schemaObjOrBoolean["enum"] = ["x86_64", "arm64", "arm"];
    }
